...
import com.anant.SpringEcom.model.Order;
import com.anant.SpringEcom.model.OrderItem;
import com.anant.SpringEcom.model.Product;
import com.anant.SpringEcom.model.dto.OrderItemRequest;
import com.anant.SpringEcom.model.dto.OrderItemResponse;
import com.anant.SpringEcom.model.dto.OrderRequest;
import com.anant.SpringEcom.model.dto.OrderResponse;
import com.anant.SpringEcom.repo.OrderRepo;
...
//            This code ensures:
//
//                   Remove the old product entry from the vector DB.
//                   Build a new textual description of the product (latest details).
//
//              Store it again in the vector DB so that AI-powered search always works with fresh
//              product info.
//--------------------------------------------------------------------------------------------------
